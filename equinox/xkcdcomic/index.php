    ...
    $url = 'http://'.$server.'/equinox/xkcdcomic/xkcdcomic.php?';
    $source = 'xkcdcomic';
...
<html lang="en">
    ...
    <body>
        ...
        <div id="viewer" class="panel panel-default">
            ...
            <div id="footer" class="footer">Help your friends see how awesome XKCD is too. <a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fcomichoard.com%2Fxkcdcomic" class="btn btn-default begsuccess btn-sm" target="_blank">Share XKCD</i></a></div>
        </div>
