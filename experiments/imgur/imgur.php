<?php
    ...
    function getcomic($i)   {
        ...
        array_push($all, '<div class="card">'.$imgstring.'<div class="details"><span>'.ucwords($name[0]).'</span><!--span class="fb-like" data-layout="button_count" data-action="like" data-show-faces="false" data-share="true" data-href="http://comichoard.com/'.$comic.'/?strip='.$url.'">Share</span--></div></div>');
