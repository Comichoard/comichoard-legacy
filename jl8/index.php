<?php
    $url = 'http://'.$_SERVER['HTTP_HOST'].'/jl8/jl8.php?';
    $source = 'jl8';
    $strip = $_GET['strip'];
    if(isset($_GET['strip']))
    ...
    <body>
        ...
        <script>
            ...
            $(document).on('click','.s',function (event) {
                ...
                window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent('http://' + $('#website').val() + '/jl8/?strip=' + $(this).attr('data-share')));
            });
