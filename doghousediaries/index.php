<?php
    ...
    $url = 'http://'.$server.'/doghousediaries/doghousediaries.php?';
...
<html lang="en">
    ...
    <body>
        ...
        <div id="viewer" class="panel panel-default">
            ...
            <div id="footer" class="footer">Help your friends see how awesome Doghouse Diaries is too. <a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fcomichoard.com%2Fdoghousediaries" class="btn btn-default begsuccess btn-sm" target="_blank">Share Doghouse Diaries</i></a></div>
        </div>
