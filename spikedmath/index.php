        ...
        <div id="viewer" class="panel panel-default">
            ...
            <?php include('../top.php');?>
                <div class="jumbotron cdesc">
                    <h1>Spiked Math <a href="http://spikedmath.com" type="button" class="btn btn-default" target="_blank">www.spikedmath.com</a><a class="fb-like btn btn-default" data-href="https://facebook.com/comichoard" data-layout="button_count" data-action="like" data-show-faces="false" data-share="true"></a><span class="btn btn-default"><a href="https://twitter.com/ComicHoard" class="twitter-follow-button" data-show-count="false" data-dnt="true">Follow @ComicHoard</a></span></h1>
                </div>
            <div class="page"></div>
